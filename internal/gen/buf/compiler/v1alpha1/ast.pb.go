...
const file_buf_compiler_v1alpha1_ast_proto_rawDesc = "" +
	...
	"\x06Import\x12G\n" +
	"\bmodifier\x18\x01 \x01(\x0e2+.buf.compiler.v1alpha1.Decl.Import.ModifierR\bmodifier\x12<\n" +
	...
	" \x01(\v2\x1b.buf.compiler.v1alpha1.SpanR\x04span\x12>\n" +
	"\fkeyword_span\x18\v \x01(\v2\x1b.buf.compiler.v1alpha1.SpanR\vkeywordSpan\x12@\n" +
	"\rmodifier_span\x18\f \x01(\v2\x1b.buf.compiler.v1alpha1.SpanR\fmodifierSpan\x12E\n" +
